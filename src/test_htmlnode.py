...
class TestLeafNode(unittest.TestCase):
    def setUp(self) -> None:
        self.empty_value_node: LeafNode = LeafNode(
...
class TestParentNode(unittest.TestCase):
    ...
    def test_to_html_with_varied_children(self) -> None:
        ...
        expected_html: str = ('<p><b>Bold text</b>Normal text'
    ...
    def test_nested_children_structure(self) -> None:
        ...
        body_nodes: list[ParentNode] = [ParentNode(
            tags.PARAGRAPH, self.nodes) for _ in range(2)]
        html_node: ParentNode = ParentNode(tags.HTML, [head_node] + body_nodes)
        expected_html: str = ("<html><head><title>This is a title.</title></head>"
